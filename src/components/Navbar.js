...
export default function Navbar() {
    return (
        <div className="flex w-screen items-center bg-blue-700 rounded-xl p-2 m-2">
            ...
            <ul className="list-none flex justify-end w-full items-center">
                ...
                <li className="rounded-xl p-2 bg-amber-500 hover:bg-amber-700"><a href="/login">Login</a></li>
